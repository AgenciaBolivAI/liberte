...
export const WEEK34_META: Record<string, Week34Meta> = {
  ...
  "20": {
    ...
    "week": 4,
    "weekEmoji": "🕐",
    "intro": "Bienvenue au Jour 20 ! Aujourd'hui, l'heure en français — et ta journée complète, du réveil au coucher. Une formule simple, trois expressions clés, et tout le jour en français.",
