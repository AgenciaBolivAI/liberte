...
import { LandingCity } from "@/components/landing3d/LandingCity";
import { useReveal } from "@/components/landing3d/useReveal";
...
const MONTHS = [
  {
    ...
    name: "J'OSE",
    subtitle: "Me atrevo",
    desc: "Tus primeras conversaciones reales: café, restaurante, compras.",
  },
  {
    img: mois2,
    name: "JE VIS",
    subtitle: "Vivo",
    desc: "El francés de la vida diaria: casa, rutina, ciudad.",
  },
  {
    img: mois3,
    name: "JE M'EXPRIME",
  ...
  },
  {
    ...
    name: "JE PARLE",
    subtitle: "Hablo",
    desc: "Conversación fluida sobre lo que te importa.",
  },
  {
    img: mois5,
    name: "JE VOYAGE",
    subtitle: "Viajo",
    desc: "Francés para viajar con confianza total.",
  },
  {
    img: mois6,
    name: "JE SUIS LIBRE",
    subtitle: "Soy libre",
    desc: "La meta: te expresas con libertad.",
  },
];
...
const STEPS = [
  {
    ...
    desc: "20-45 minutos al día con vocabulario, audio y práctica guiada. Tu progreso se guarda solo.",
  },
  {
    icon: Mic,
    title: "Défis con IA",
    desc: "Cada día terminas hablando: grabas tu voz y una profesora IA te evalúa y corrige al instante.",
  },
  {
    icon: Video,
    title: "Clases en vivo",
    desc: "8 clases al mes por Zoom con tu profesora, en horarios para Europa y América.",
  },
  {
    icon: Star,
    title: "Estrellas y rachas",
    desc: "Ganas estrellas por cada logro y ves tu progreso crecer semana a semana.",
  },
];
...
function LandingPage() {
  ...
  return (
    <div className="relative bg-[#0B1130] text-white">
      {/* The 3D night-flight (or its static fallback) lives behind everything. */}
      <LandingCity />
      <div className="relative z-10">
        {/* Nav */}
        <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0B1130]/70 backdrop-blur-xl">
          <div className="mx-auto flex h-16 max-w-6xl items-center justify-between gap-2 px-4 sm:px-6">
            <img
              src={logoFull.url}
              alt="Liberté · Instituto de Francés"
              className="h-8 w-auto max-w-[32vw] shrink object-contain object-left brightness-0 invert sm:h-10 sm:max-w-none"
            />
            {/* Login must stay reachable on phones — students land here too. */}
            <div className="flex shrink-0 items-center gap-1 sm:gap-2">
              <Link
                to={LOGIN_PATH}
                className="whitespace-nowrap rounded-full px-3 py-2 text-sm font-semibold text-white/90 transition hover:text-sky"
              >
              ...
              <Button
                asChild
                className="rounded-full bg-gradient-blue px-4 font-bold whitespace-nowrap text-white sm:px-6"
              >
                <a href="#inscripcion">
            ...
            <div className="max-w-2xl">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Button
                  asChild
                  size="lg"
                  className="rounded-full bg-gradient-blue px-8 font-display text-base font-extrabold text-white shadow-card"
                >
                  <a href="#inscripcion">
                ...
                <Button
                  ...
                  size="lg"
                  variant="outline"
                  className="rounded-full border-white/40 bg-white/10 px-8 text-base font-bold text-white hover:bg-white/20"
                >
        ...
        {/* Program: 6 months */}
        <section data-flight="1" className="flex min-h-[100svh] items-center py-16 sm:py-20">
          <div data-reveal className="mx-auto w-full max-w-6xl px-4 sm:px-6">
            <div className="text-center">
              <p className="text-xs font-bold tracking-widest text-sky uppercase">El viaje</p>
            ...
            <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {MONTHS.map((m, i) => (
                <div
                  key={m.name}
                  className="overflow-hidden rounded-3xl border border-white/15 bg-white/10 shadow-soft backdrop-blur-md transition hover:shadow-card"
                >
                  <img
                    src={m.img.url}
                    alt={`Mes ${i + 1}: ${m.name}`}
                  ...
                  <div className="p-5">
                    ...
                    <h3 className="font-display text-xl font-extrabold">
                      {m.name}{" "}
                      <span className="text-sm font-bold text-white/60">· {m.subtitle}</span>
                    </h3>
        ...
        {/* How it works */}
        <section data-flight="2" className="flex min-h-[100svh] items-center py-16 sm:py-20">
          <div data-reveal className="mx-auto w-full max-w-6xl px-4 sm:px-6">
            <div className="rounded-3xl border border-white/10 bg-[#131b36]/60 p-6 backdrop-blur-md sm:p-10">
              <div className="text-center">
                <p className="text-xs font-bold tracking-widest text-sky uppercase">El método</p>
                <h2 className="mt-2 font-display text-3xl font-extrabold sm:text-4xl">
                  Así aprendes cada día
                </h2>
              </div>
              <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {STEPS.map((s, i) => (
                  <div key={s.title} className="rounded-3xl bg-white/10 p-6">
                    <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-blue text-white shadow-soft">
                      <s.icon className="h-5 w-5" />
                    </div>
                    <p className="mt-4 text-[10px] font-bold tracking-widest text-sky uppercase">
                      Paso {i + 1}
                    </p>
        ...
        <section
          data-flight="3"
          className="flex min-h-[100svh] items-center py-16 text-white sm:py-20"
        >
          <div
            data-reveal
            className="mx-auto grid w-full max-w-6xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2"
          >
            <div className="rounded-3xl border border-white/10 bg-[#0B1130]/70 p-6 backdrop-blur-md sm:p-8">
              <p className="text-xs font-bold tracking-widest text-sky uppercase">
                La IA de Liberté
              </p>
              <h2 className="mt-2 font-display text-3xl font-extrabold sm:text-4xl">
              ...
              <ul className="mt-6 space-y-4">
                {[
                  [
                    "Conversa cuando quieras",
                    "Lib, la tutora IA, charla contigo en francés sobre lo que estás aprendiendo — por texto o por voz.",
                  ],
                  [
                    "Correcciones con cariño",
                    "Cada desafío hablado se evalúa al momento: qué hiciste bien, qué mejorar y cómo decirlo.",
                  ],
                  [
                    "Informe semanal",
                    "Tu examen de la semana genera un informe con tu nota, fortalezas y plan de práctica.",
                  ],
                ].map(([title, desc]) => (
            ...
            <div className="relative mx-auto w-full max-w-sm">
              <div className="rounded-3xl border border-white/15 bg-[#0B1130]/60 p-5 shadow-card backdrop-blur-md">
          ...
          <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
            ...
            <div className="mt-10 grid gap-5 md:grid-cols-3">
              {TESTIMONIALS.map((t) => (
                <figure
                  key={t.name}
                  className="rounded-3xl border border-navy/10 bg-white p-6 shadow-soft"
                >
        ...
        >
          <div data-reveal className="mx-auto w-full max-w-xl px-4 sm:px-6">
            <div className="rounded-3xl bg-white/95 p-6 text-navy shadow-2xl backdrop-blur-xl sm:p-10">
              <div className="text-center">
        ...
        {/* FAQ */}
        <section data-flight="5" className="flex min-h-[100svh] items-center py-16 sm:py-20">
          <div data-reveal className="mx-auto w-full max-w-3xl px-4 sm:px-6">
            <div className="rounded-3xl border border-white/10 bg-[#131b36]/60 p-6 backdrop-blur-md sm:p-8">
              <h2 className="text-center font-display text-3xl font-extrabold sm:text-4xl">
                Preguntas frecuentes
              </h2>
              <Accordion type="single" collapsible className="mt-8">
                {FAQ.map((f, i) => (
                  <AccordionItem key={i} value={`q${i}`} className="border-white/15">
        ...
        <footer
          data-flight="6"
          className="flex min-h-[70svh] items-end border-t border-white/10 bg-linear-to-b from-transparent to-[#0B1130]/80 pb-14 pt-10 text-white"
        >
          <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-4 px-4 text-center sm:px-6">
            ...
            <p className="text-sm text-white/70">
              Tu programa premium de 6 meses para hablar francés.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm">
              <Link to={LOGIN_PATH} className="text-sky hover:text-white">
                Iniciar sesión
              </Link>
              <a href="#inscripcion" className="text-sky hover:text-white">
                Inscripción
              </a>
              <a href="mailto:hola@libertefrances.com" className="text-sky hover:text-white">
                hola@libertefrances.com
              </a>
            </div>
            <p className="text-xs text-white/50">
              © {new Date().getFullYear()} Liberté · Instituto de Francés
            </p>
            <p className="text-xs text-white/50">
              Made by{" "}
              <a
      ...
      if (res.status === 502) {
        ...
        setError(
          body?.error === "Datos inválidos"
            ? "Revisa tu nombre y tu correo."
            : (body?.error ?? "Revisa tus datos."),
        );
      } else {
